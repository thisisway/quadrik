...
export function Sidebar({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <aside className="flex h-full w-60 flex-col bg-q-navy text-white">
      {/* Logo */}
      <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-[10px] bg-grad-sun shadow-sm">
          <div className="h-4 w-4 rounded-full border-[3px] border-white" />
        </div>
        <span className="text-lg font-black tracking-tight">Quadrik</span>
      </div>
